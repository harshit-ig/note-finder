        ...
        <div className="lg:flex lg:items-center lg:justify-between">
          ...
          >
            <div className="flex flex-col space-y-4 lg:flex-row lg:items-center lg:space-y-0 lg:space-x-10">
              ...
              <Link to="/upload" className="hover:text-gray-400">Upload Notes</Link>
              <Link to="/my-notes" className="hover:text-gray-400">My Notes</Link>
              ...
              <div className="relative mt-4 lg:mt-0 lg:ml-4">
                ...
                <input
                  type="text"
                  className="w-full py-1 pl-10 pr-4 text-gray-700 placeholder-gray-500 bg-white border-b border-gray-600 dark:placeholder-gray-400 dark:focus:border-gray-300 lg:w-56 lg:border-transparent dark:bg-gray-800 dark:text-gray-300 focus:outline-none focus:border-gray-600"
                  placeholder="Search"
                />
              </div>
            ...
            <div className="flex justify-center mt-6 lg:flex lg:mt-0 lg:ml-4">
